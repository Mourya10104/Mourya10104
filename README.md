# Hey, I'm Mourya Varma

### Front-End Developer | React & Next.js | Building things that look good and work well
...
A production-grade storefront built with Next.js 14, TypeScript, Tailwind CSS, and Stripe.
Features ISR, static generation, Zustand cart persistence, dark mode, auth, admin dashboard, multi-currency, order history, and product reviews.
